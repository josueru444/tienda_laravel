...
@section('content')
    ...
    <div class="grid grid-cols-1 items-center align-middle left-0 justify-center">
        <h1 class="text-3xl text-white text-center pt-3 pb-5 col-span-3 w-full">Comprar producto</h1>
            ...
            <div class="col-span-2">      
                <div class="bg-slate-800 p-5 mx-36 my-4 rounded-2xl flex gap-5 text-white">
                    ...
                    <div>
                        ...
                        <input disabled id="quantity" min="1" max="{{$item->stock}}" type="number" value="1" class="bg-slate-700 py-1 text-white w-auto text-center rounded-lg border-2 border-gray-500 m-2">
...
<dialog id="modal_paypal" class="modal">
  <div class="modal-box w-11/12 max-w-5xl">
    ...
    <form action="{{ route('paypal')}}" method="POST" class="flex flex-col gap-4">
      ...
      <input  type="text" id="addres-paypal-input" class="text-white text-xl bg-slate-700 border-2 border-gray-500 rounded-md px-4 py-2">
